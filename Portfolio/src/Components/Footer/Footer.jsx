      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-contact animate-up" style={{ animationDelay: '0.3s' }}>
            <h4>Get In Touch</h4>
            <p>
              <i className="fas fa-envelope"></i> gauravprakash380@gmail.com
            </p>
            <p>
              <i className="fas fa-phone"></i> +91 6203632302
            </p>
          </div>
        ...
        <div className="footer-bottom animate-up" style={{ animationDelay: '0.5s' }}>
          <p>&copy; {currentYear} <span>Gaurav Prakash</span>. All rights reserved.</p>
          <p className="footer-credit">
            Designed & Built with <i className="fas fa-heart"></i> by Gaurav Prakash.
          </p>
        </div>
      </div>
